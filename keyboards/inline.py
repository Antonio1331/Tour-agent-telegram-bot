...
def travel_pagination_buttons(travel_id: int, page: int=1):
    ...
    image = db.select_images_by_pagination(travel_id, offset, limit)[1]

    previous = InlineKeyboardButton("⏮️", callback_data=f"image_{travel_id}")
    ...
    back = InlineKeyboardButton("Back", callback_data="to_back_")
